...
"""
    Config app's URL configurations.
    This file configures and registers the endpoints for the API's written in the 'api.views.py'
"""
...
urlpatterns = [
    ...
    path ("add_channel_type/<str:engagement_id>",views.addChannelType,name = "add_channel_type"),
    ...
    path("view-channel-types/<str:engagement_id>",views.viewChannelTypes),
