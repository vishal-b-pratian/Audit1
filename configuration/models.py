...
class Engagement(models.Model):
    id = models.UUIDField(
        default=uuid.uuid4, verbose_name="Engagement Id", primary_key=True, editable=True
    )
...
class ChannelTypeParameter(models.Model):
    ...
    def __str__(self):
        return f'{self.parameters} | {self.type_name}'
...
class ChannelParameter(models.Model):
    ...
    def __str__(self):
        return f'{self.parameters} | {self.channel}'
