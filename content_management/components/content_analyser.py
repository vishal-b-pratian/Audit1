...
class ContentAnalyser():
    ...
    def __init__(self,text_data,parameters):
        ...
        """
        Class constructor takes web scraped data and audit parameter keywords as arguments         
        """
    ...
    def preprocessing(self):
        """
        this function cleans the web scraped data and
        ecreats a list of usefull words extracted from it 
        """
        text = self.text_data
    ...
    def count_mapped_keywords(self):
        """
        Calculates the number of audit parameter keywords
        that could be mapped to words processed from the scraped data 
        """
        mapped_count = 0
    ...
    def final_unmapped(self):
        """
        Returns the number of audit parameter keywords
        that could not be mapped to words processed from the scraped data 
        """
        uniques_keys=list(self.final_dict.keys())
        unmapped_words = []
        for i in uniques_keys:
